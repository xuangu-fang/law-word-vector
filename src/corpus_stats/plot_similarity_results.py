...
# -*- coding: utf-8 -*-
"""
读取 similarity_analysis_results.json 文件，并根据两种setting绘制图表:
1. 柱状图: 显示每个时期法治/法制与label-1/label-2词语的相似度
2. 趋势图: 显示每个时期法治/法制相似度的gap指数变化
"""
...
def main():
    ...
    results_path = base_dir / "output" / "similarity_analysis" / "similarity_analysis_results.json"
    plot_output_dir = base_dir / "output" / "similarity_plots"
    
    plotter = ResultPlotter(results_path, plot_output_dir)
