...
功能：
1. 分析"工具、战略、合法"三个法律功能维度
2. 计算"法治"/"法制"与各维度的相似度
3. 支持多种era-keyword组合和归一化模式
4. 生成雷达图、趋势图、热力图
5. 使用General Union模式确保词包一致性

输出目录：output/topic_analysis/law-function-new/
"""
...
OUTPUT_DIR = PROJECT_ROOT / "output" / "topic_analysis" / "law-function-new"
DATA_PATH = PROJECT_ROOT / "output" / "topic_analysis" / "law-function-new" / "topic_word_sets_law_function.json"
