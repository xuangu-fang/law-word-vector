...
OUTPUT_DIR = PROJECT_ROOT / "output" / "topic_analysis" / "inner_actual_justice"
DATA_PATH = PROJECT_ROOT / "output" / "topic_analysis" / "inner_actual_justice" / "topic_word_sets.json"
...
class LegalProcessAnalyzer:
    ...
    def plot_heatmap(self, df, path, title):
        ...
        custom_yticklabels = [ "实质正义", "程序正义"]  # 根据实际topic数量自定义
