...
# -*- coding: utf-8 -*-
"""
Topic Analysis - 法律功能分析器

功能：
1. 分析"发展、秩序、规范、权力限制"四个法律功能维度
2. 计算"法治"/"法制"与各维度的相似度
...
OUTPUT_DIR = PROJECT_ROOT / "output" / "topic_analysis" / "law-function"
DATA_PATH = PROJECT_ROOT / "output" / "topic_analysis" / "law-function" / "topic_word_sets_law_function.json"

class LawFunctionAnalyzer:
    ...
    def _create_general_union_wordset(self):
        ...
        # 保存到JSON文件
        general_union_path = self.output_dir / "general_union_wordset_law_function.json"
...
if __name__ == '__main__':
    ...
    try:
        ...
        print("初始化分析器...")
        analyzer = LawFunctionAnalyzer(models)
        
        print("数据加载成功，开始分析...")

        print("\n" + "="*80)
        print("🏛️ 法律功能分析: 发展、秩序、规范、权力限制")
